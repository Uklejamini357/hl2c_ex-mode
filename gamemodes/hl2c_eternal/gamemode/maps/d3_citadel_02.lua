...
function hl2cAcceptInput(ent, input)
	...
	if !game.SinglePlayer() and ent:GetName() == "track_dump" and string.lower(input) == "enable" then
		if timer.Exists("hl2cUpdatePlayerPosition") then timer.Remove("hl2cUpdatePlayerPosition") end
