...
function hl2cAcceptInput(ent, input)
	if !game.SinglePlayer() and ent:GetName() == "aisc_attentiontoradio" and input:lower() == "enable" then
	...
	if !game.SinglePlayer() and ent:GetName() == "aisc_leon_waits" and input:lower() == "enable" then
		ents.FindByName("warehouse_leonleads_lcs")[1]:Fire("Start")
		return true
	end

	if !game.SinglePlayer() and ent:GetName() == "aisc_leaonwait1" and input:lower() == "enable" then
	...
	if ent:GetName() == "lcs_leon_radios3" and string.lower(input) == "start" then
