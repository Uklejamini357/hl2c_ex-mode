...
HL2CE_NETVOTETYPE_STARTVOTE = 1
HL2CE_NETVOTETYPE_CANCELVOTE = 2
HL2CE_NETVOTETYPE_ENDVOTE = 3
HL2CE_NETVOTETYPE_DOVOTE = 4

REVIVE_SENDDEADPLAYERS = 1
REVIVE_PLAYERSTARTREVIVE = 2
REVIVE_PLAYERSTOPREVIVE = 3
REVIVE_PLAYERREVIVED = 4


-- maybe homescreen part later
GAMESTATE_HOMESCREEN = 1
GAMESTATE_WAITINGFORPLAYERS = 2
GAMESTATE_PRESTART = 3
GAMESTATE_RUNNING = 4
GAMESTATE_FAILED = 5
GAMESTATE_COMPLETED = 6
GAMESTATE_RESTARTING = 7
GAMESTATE_CHANGINGLEVEL = 8

-- test
SINGLEPLAYER_FAILMAP_STYLE = game.SinglePlayer()
SHOW_MAP_COMPLETIONS = true
