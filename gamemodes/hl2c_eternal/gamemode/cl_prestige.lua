local function FirstPrestige()
	...
	local function Loseit()
		...
		chat.AddText(Color(0,255,0), "Each level up awards you with 2 skill points.")
		chat.AddText(Color(0,255,0), "Skills max level are increased to 35 levels.")
	end
	...
	text1:SetFont("hl2ce_hudfont_small")
	...
	text2:SetFont("hl2ce_hudfont_small")
	text2:SetText("Congratulations on your first Prestige.")
	text2:SetAlpha(0)
	...
	text3:SetFont("hl2ce_hudfont_small")
	text3:SetText("You seem to begin understanding the mechanics of this gamemode.")
	text3:SetAlpha(0)
	...
	text4:SetFont("hl2ce_hudfont_small")
	text4:SetText(string.format("\"%s\"? That's a cool name.", pl:Nick()))
	text4:SetAlpha(0)
	...
	text5:SetFont("hl2ce_hudfont_small")
	text5:SetText("And we are the...")
	text5:SetAlpha(0)
...
local function FirstEternity()
	...
	text6:SetFont("hl2ce_hudfont_small")
	...
	text7:SetFont("hl2ce_hudfont_small")
	...
	text8:SetFont("hl2ce_hudfont_small")
...
local function FirstCelestialize()
	...
	text9:SetFont("hl2ce_hudfont_small")
	...
	timer.Simple(30, function()
		...
		timer.Simple(1, function()
			...
			chat.AddText(Color(0,155,244), "This is the final prestige layer for now.")
			chat.AddText(Color(0,155,244), "More will come, but for now this is the last one.")
			-- chat.AddText(Color(0,155,244), "Unlocked Challenges.")
			chat.AddText(Color(0,155,244), "Max Level increased to 1000, Max Prestige increased to 200 and Max Eternities to 50.")
